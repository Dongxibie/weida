...
export default function Head() {
	return (
		<head>
			...
			<link
				href='https://fonts.googleapis.cn/css2?family=Outfit:wght@400;500;600;700;800;900&family=Fustat:wght@500;600;700;800&family=Inter:wght@400;500;600;700&display=swap'
				rel='stylesheet'
			/>
